      ...
      <View style={style.container}>
                ...
                <View style={style.box}>
                    ...
                    <View style={style.avatar}>
                        <Image style= {{ alignSelf: "center", borderRadius: 100, marginTop: -width/6, width: height/8, height: height/8, position: "relative"}} source={avatar} />
                        <Text style={{alignSelf: "center",color:"#5E72E4", fontFamily: "OleoScript_400Regular", fontSize: width/20 }}>Shrek The Almighty</Text>
